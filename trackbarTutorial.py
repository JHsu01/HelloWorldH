...
parser.add_argument('--input1', help='Path to the first input image.', default='image.jpg')
parser.add_argument('--input2', help='Path to the second input image.', default='test.jpg')
